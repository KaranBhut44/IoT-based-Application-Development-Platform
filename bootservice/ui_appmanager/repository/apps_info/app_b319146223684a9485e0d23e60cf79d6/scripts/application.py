...
while True:
	...
	if(threshold<Total_temp):
	    action_and_notification_api.send_notification("High temperature detected!... Received Temptature: " + str(AC1[0]))
	else:
	    action_and_notification_api.send_notification("Low temperature detected!... Received Temptature: " + str(AC1[0]))
